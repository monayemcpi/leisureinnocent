...
<div id="ags-psrf-settings-container">
    <div id="ags-psrf-settings">
        <div id="ags-psrf-settings-header">
            ...
            <div id="ags-psrf-settings-header-links">
                ...
                <a id="ags-psrf-settings-header-link-upgrade" href="https://aspengrovestudios.com/product/product-sales-report-pro-for-woocommerce/?utm_source=export-order-items-for-woocommerce&amp;utm_medium=link&amp;utm_campaign=wp-plugin-upgrade-link"
        ...
        <div class="ags-psrf-settings-sidebar">
            <div class="ags-psrf-widget">
                ...
                <div class="inside">
                    ...
                    <p><strong>' . sprintf(esc_html__('Upgrade to %sProduct Sales Report Pro%s for the following additional features:', 'product-sales-report-for-woocommerce'), '<a href="https://aspengrovestudios.com/product/product-sales-report-pro-for-woocommerce/?utm_source=product-sales-report&amp;utm_medium=link&amp;utm_campaign=wp-plugin-upgrade-link" target="_blank">', '</a>') . '</strong></p>
                    ...
                    <a href="https://aspengrovestudios.com/product/product-sales-report-pro-for-woocommerce/?utm_source=product-sales-report&amp;utm_medium=link&amp;utm_campaign=wp-plugin-upgrade-link" target="_blank" class="ags-psrf-button-secondary">' . esc_html__('Buy Now', 'product-sales-report-for-woocommerce') . '</a>
                </div>
            </div>
            ...
            <div class="ags-psrf-widget">
                ...
                <div class="inside">
                    ...
                    <a href="https://aspengrovestudios.com/product/scheduled-email-reports-for-woocommerce/?utm_source=product-sales-report&amp;utm_medium=link&amp;utm_campaign=wp-plugin-upgrade-link" target="_blank" class="ags-psrf-button-secondary">' . esc_html__('Get the add-on plugin', 'product-sales-report-for-woocommerce') . '</a>
                </div>
            </div>
            ...
            <div class="ags-psrf-widget">
                ...
                <div class="inside">
                    ...
                    <a href="https://aspengrovestudios.com/product/frontend-reports-for-woocommerce/?utm_source=product-sales-report&amp;utm_medium=link&amp;utm_campaign=wp-plugin-upgrade-link" target="_blank" class="ags-psrf-button-secondary">' . esc_html__('Get the add-on plugin', 'product-sales-report-for-woocommerce') . '</a>
                </div>
            </div>
    ...
    <div id="ags-psrf-settings-addons"> ');
            define('AGS_PSRF_ADDONS_URL', 'https://divi.space/wp-content/uploads/product-addons/product-sales-report-free.json');
